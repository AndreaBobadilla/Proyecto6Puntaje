...
document.querySelectorAll(".item").forEach(item =>{
    item.addEventListener("mouseover", e =>{
        ...
        document.querySelectorAll(".item").forEach(cuadraditoNormal => {
            if (cuadraditoNormal.classList.contains("selec")) {
                cuadraditoNormal.classList.remove("selec");
            }
        });
    ...
    item.addEventListener("click", (e) => {
        ...
        pantalla.textContent = puntajeActual;
    });
});